"""
Example 6 abaqus script
=======================

Using czmtestkit modules to run a single element test without substrates using czm definition from user subroutine. 
This script
...
ctkApy.NonStdWithSub(CZ_type="UEL")
...
myJob.setValues(userSubroutine='..\FDF.for')
