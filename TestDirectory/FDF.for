...
C	  A-H or O-Z are defined as REAL(4) variables. 
...
C     DECLARING INTERNAL VARIABLES
     ...
     1 X(24,1),I(3,3),L(12,24),M(12,24),N(3,12),B1(3,12),B2(3,12),    
     2 T1(3,1),T2(3,1),T3(3,1),R(3,3),W(4),CP(2),IP(2,4),DG(3,24), 
     3 DR(3,24),GIP(3,1),TAU(3),DA(3,1),DETJ,DTAU(3,3),SVARIP(5),
     4 SVARSL(NSVARS),ZERO,ONE,HALF,TWO
...
C-----------------------------------------------------------------------
      ...
      INTEGER :: IT,IT1
      REAL(4) ZERO, ONE, QUART, NI(4), BI1(4), BI2(4)
...
C-----------------------------------------------------------------------
      ...
      REAL(4) Z(24,1), DE1(3), DE2(3), DE3(3),  DE(3,3), 
     1 DRI(3,1), DI(3), DT1(3,1), DT2(3,1), DT3(3,1), ZERO, ONE
      REAL(4), INTENT(IN) :: G(3,1), B1(3,12), B2(3,12),
     1 M(12,24), T1(3,1), T2(3,1), T3(3,1)
      REAL(4), INTENT(OUT) :: DR(3,24)
      INTEGER IT
...
C-----------------------------------------------------------------------
      ...
      REAL(4) TEMP1(3,1), TEMP2(3,1)
      REAL(4), INTENT(IN) :: A(3,1), B(3,1), DA(3,1), DB(3,1)
      REAL(4), INTENT(OUT) :: DN(3,1)
      EXTERNAL CROSS
...
C-----------------------------------------------------------------------
      ...
      REAL(4) VMAG, DVMAG, TEMP(1,1)
      REAL(4), INTENT(IN) :: V(3,1), DV(3,1)
      REAL(4), INTENT(OUT) :: DU(3,1)
      VMAG = SQRT(SUM(V*V))
...
C     READING REMAINING MATERIAL PROPERTIES
      TAUN = PROPS(2) !NORMAL STRENGTH
      TAUT = PROPS(3) !TANGENTIAL STRENGTH
      GNC = PROPS(4) !FRACTURE TOUGHNESS MODE-1
      GTC = PROPS(5) !FRACTURE TOUGHNESS MODE-2 & MODE-3
      ETA = PROPS(6) !B-K PARAMETER
