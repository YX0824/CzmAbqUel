"""
Example 4 abaqus script
=======================

Using czmtestkit modules to run a single element test with substrates using czm definition from abaqus material library. 
This script
