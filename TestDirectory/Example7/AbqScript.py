"""
Example 7 abaqus script
=======================

Using czmtestkit modules to run a four element test with substrates using czm definition from abaqus material library. 
This script
...
ctkApy.NonStdWithSub(MeshSeed=0.5)
